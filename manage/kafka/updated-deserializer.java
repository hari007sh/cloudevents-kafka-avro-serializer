public package com.ibm.build2manage.messaging.kafka;
...
public class CloudEventDeserializer<T> implements Deserializer<T> {
    ...
    private void invokeSetterMethod(Class<T> targetClass, T targetObject, String fieldName, Object value) {
        ...
        try {
            ...
            Objects.requireNonNull(setter).invoke(targetObject, value);
    ...
    private Method findMapSetter(Class<T> targetClass, String fieldName) throws NoSuchMethodException {
        return targetClass.getMethod(buildSetterName(fieldName), Map.class);
    }
        ...
        try {
            ...
            for (Schema.Field field : ((GenericRecord) genericRecordObject).getSchema().getFields()) {
                ...
                if (value instanceof Utf8) {
                    ...
                    value = processMapValues((Map<?, ?>) value);
                }
